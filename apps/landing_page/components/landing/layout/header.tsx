    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        <Link
          ...
          href="/"
        >
          <span className="flex h-10 w-10 items-center justify-center rounded-2xl bg-card/80 shadow-sm transition-all duration-300 group-hover:shadow-md group-hover:scale-105">
            <Image
              src={iconImage}
              alt="Cookmate"
              width={40}
          ...
          <span className="text-lg font-display text-foreground transition-colors duration-300 group-hover:text-primary">
            Cookmate
          </span>
        </Link>
