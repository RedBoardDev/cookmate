...
export type CollectionMemberSelectResult<TSelect extends Prisma.CollectionMemberSelect> =
  Prisma.CollectionMemberGetPayload<{
    select: TSelect;
  }>;

export type CollectionMemberIncludeResult<TSelect extends Prisma.CollectionMemberInclude> =
  Prisma.CollectionMemberGetPayload<{
    include: TSelect;
  }>;
